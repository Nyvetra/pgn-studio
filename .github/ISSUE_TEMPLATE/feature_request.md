...
about: Suggest an idea for PGN Studio
title: ""
labels: enhancement
---

**What problem would this solve?**
A clear description of the problem or workflow gap. If it's tied to a
specific `pgn-extract` capability, link to the relevant part of the
upstream help/documentation if you can.
